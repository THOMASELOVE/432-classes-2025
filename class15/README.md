...
2. The [Demonstration for Project A](https://thomaselove.github.io/432-2025/432_projectA_demo.html) shows the minimum requirements for a low B grade on the project. The main things that are missing in the Demonstration is careful interpretation and explanation of some of the ideas and code. You need to include those pieces in order to move from a low B to an A grade.
