...
3. Every student who came to me over the break with a problem fitting a model B or model Z had included multiple non-linear terms. If you note (for instance) that your complicated model isn't fitting properly, fit a simpler one, with fewer non-linear terms.
