...
7. On 2025-03-04, I updated the `sup1000` example on our Shared Drive to include new sections 5-8, which cover the main regression modeling approaches we will see after Spring Break.
