...
4. I had hoped to have the `support1000` example's material on linear and logistic regression completely finished by class time today, but regrading Lab 3 took too long, and I will not meet that deadline. I will let you know on Campuswire as soon as the "final" version of those sections of the example are available and posted to our Shared Drive.
